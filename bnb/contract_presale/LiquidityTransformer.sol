...
contract LiquidityTransformer {
    ...
    UniswapRouterV2 public constant UNISWAP_ROUTER = UniswapRouterV2(
         0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F // bscmainnet  //pancakeswap
    );
    ...
    address constant WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // bscmainnet //wbnb
  
    uint8 constant INVESTMENT_DAYS = 50;
    uint8 constant MAX_DAY_SLOT = 207;

    uint128 constant THRESHOLD_LIMIT_MIN = 500000000000000000 wei;
    ...
    constructor(address _griseToken, address _refundSponsor) {
        GRISE_CONTRACT = IGriseToken(_griseToken);
